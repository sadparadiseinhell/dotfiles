...
static const char *play[]          = { "/bin/sh", "-c", "$HOME/scripts/mpdctrl.sh play", NULL };
static const char *next[]          = { "/bin/sh", "-c", "$HOME/scripts/mpdctrl.sh next", NULL };
static const char *prev[]          = { "/bin/sh", "-c", "$HOME/scripts/mpdctrl.sh prev", NULL };
